...
REM Compile WindowsDynamicLightingSync.cpp with Qt 6.8.3
echo Compiling WindowsDynamicLightingSync.cpp with Qt 6.8.3...
cl -c -nologo -O2 -MD -std:c++17 -Zc:__cplusplus -EHsc -DWINDOWSDYNAMICLIGHTINGSYNC_LIBRARY -DVERSION_STRING="\"1.0\"" -DGIT_COMMIT_ID="\"\"" -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB -I. -I"../dependencies/OpenRGBSamplePlugin/OpenRGB" -I"../dependencies/OpenRGBSamplePlugin/OpenRGB/i2c_smbus" -I"C:/Qt/6.8.3/msvc2022_64/include" -I"C:/Qt/6.8.3/msvc2022_64/include/QtCore" -I"C:/Qt/6.8.3/msvc2022_64/include/QtWidgets" -I"C:/Qt/6.8.3/msvc2022_64/include/QtGui" -Fo"_intermediate_release/.obj/" WindowsDynamicLightingSync.cpp
